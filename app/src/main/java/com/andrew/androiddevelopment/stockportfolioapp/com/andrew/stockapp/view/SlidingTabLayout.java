...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        final ChartImageTabAdapter adapter = (ChartImageTabAdapter) mViewPager.getAdapter();
        final View.OnClickListener tabClickListener = new TabClickListener();
        Resources res = getResources();
        String[] chart_names = res.getStringArray(R.array.chart_name_array);

        for (int i = 0; i < adapter.getCount(); i++) {
            Log.d("Debug strings", String.valueOf(i));
            View tabView = null;
            ...
            Log.d("Debug strings", chart_names[i]+" "+i);
            tabTitleView.setText(chart_names[i]);
            tabTitleView.setTextColor(R.color.black);
